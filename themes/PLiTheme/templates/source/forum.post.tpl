{***************************************************************************}
{*                                                                         *}
{* PLi-Fusion CMS template: forum.post.tpl                                 *}
{*                                                                         *}
{***************************************************************************}
{*                                                                         *}
			...
			<tr>
				...
				<td class='tbl1'>
					<select class='textbox' id='fpm_type' name='fpm[type]'>
						<option value='0'{if $fpm.type == 0} selected{/if}>{$locale.FPM_300}</option>
						<option value='1'{if $fpm.type == 1} selected{/if}>{$locale.FPM_301}</option>
					</select>
				</td>
			</tr>
			<tr>
