...
include PATH_LOCALE.LOCALESET."admin/admins.php";
...
$template_panels[] = array('type' => 'body', 'name' => 'admin.administrators', 'template' => 'admin.administrators.tpl', 'locale' => PATH_LOCALE.LOCALESET."admin/admins.php");
