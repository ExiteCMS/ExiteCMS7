...
$variables['message'] = str_replace('<h1>', '<center><h1 style="font-size: 150%;">', $variables['message']);
$variables['message'] = str_replace('</h1>', '</h1></center>', $variables['message']);
$variables['message'] = str_replace('<h2>', '<center><h2 style="font-size: 125%;">', $variables['message']);
