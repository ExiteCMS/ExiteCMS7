...
$variables['options'][] = "%m/%d/%Y";
$variables['options'][] = "%d/%m/%Y";
$variables['options'][] = "%d-%m-%Y";
$variables['options'][] = "%d.%m.%Y";
$variables['options'][] = "%m/%d/%Y %H:%M";
$variables['options'][] = "%d/%m/%Y %H:%M";
$variables['options'][] = "%d-%m-%Y %H:%M";
$variables['options'][] = "%d.%m.%Y %H:%M";
$variables['options'][] = "%m/%d/%Y %H:%M:%S";
$variables['options'][] = "%d/%m/%Y %H:%M:%S";
$variables['options'][] = "%d-%m-%Y %H:%M:%S";
$variables['options'][] = "%d.%m.%Y %H:%M:%S";
$variables['options'][] = "%B %d %Y";
$variables['options'][] = "%d. %B %Y";
$variables['options'][] = "%d %B %Y";
$variables['options'][] = "%B %d %Y %H:%M";
$variables['options'][] = "%d. %B %Y %H:%M";
$variables['options'][] = "%d %B %Y %H:%M";
$variables['options'][] = "%B %d %Y %H:%M:%S";
$variables['options'][] = "%d. %B %Y %H:%M:%S";
$variables['options'][] = "%d %B %Y %H:%M:%S";
