...
$revisions[] = array('revision' => $_revision, 'date' => mktime(18,58,0,7,17,2007), 'description' => "Required updates for ExiteCMS v7.00 rev.".$_revision."<br /><font color='red'>This revision introduces the new PM system, and drops support for the Photo Albums, Weblinks and Submissions modules.</font>");
...
$commands[] = array('type' => 'db', 'value' => "CREATE TABLE ##PREFIX##pm (
  ...
  pm_recipients text NOT NULL default '',
...
$commands[] = array('type' => 'db', 'value' => "CREATE TABLE ##PREFIX##pm_attachments (
  ...
  pm_id smallint(5) unsigned NOT NULL,
  pmattach_name varchar(100) collate latin1_general_ci NOT NULL default '',
  pmattach_realname varchar(100) collate latin1_general_ci NOT NULL default '',
  pmattach_comment varchar(255) collate latin1_general_ci NOT NULL default '',
  pmattach_ext varchar(5) collate latin1_general_ci NOT NULL default '',
