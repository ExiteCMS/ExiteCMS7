...
// Date generated  : `29/06/2008 16:09`
//----------------------------------------------------------

define('CMS_VERSION', '7.10');
define('CMS_REVISION', '1477');
...
if (!$result) {
	...
	$result = dbquery("INSERT INTO ".$db_prefix."configuration (cfg_name, cfg_value) VALUES('counter', '736')");
	...
	$result = dbquery("INSERT INTO ".$db_prefix."configuration (cfg_name, cfg_value) VALUES('email_verification', '0')");
	...
	$result = dbquery("INSERT INTO ".$db_prefix."configuration (cfg_name, cfg_value) VALUES('revision', '1477')");
