...
var SWFUpload = function (settings, locales) {
	this.initSWFUpload(settings, locales);
};

SWFUpload.prototype.initSWFUpload = function (settings, locales) {
	try {
...
SWFUpload.prototype.loadFlash = function () {
	...
	if (document.getElementById(this.movieName) !== null) {
		throw "ID " + this.movieName + this.locales["MovienameExists"];
	}
	...
	if (targetElement == undefined) {
		throw this.locales["BodyMissing"];
	}
...
SWFUpload.prototype.getMovieElement = function () {
	...
	if (this.movieElement === null) {
		throw this.locales["FlashMissing"];
	}
...
SWFUpload.prototype.callFlash = function (functionName, argumentArray) {
	...
	var callFunction = function () {
		...
		if (typeof(movieElement[functionName]) === "function") {
			...
			throw this.locales["InvFunction"];
		}
	};
...
SWFUpload.prototype.queueEvent = function (handlerName, argumentArray) {
	...
	if (typeof(this.settings[handlerName]) === "function") {
		...
		throw this.locales["EventHandler"] + handlerName + this.locales["EHunknown"];
	}
};
...
SWFUpload.prototype.flashReady = function () {
	...
	if (typeof(movieElement.StartUpload) !== "function") {
		throw this.locales["ExtMethFailed"];
	}
