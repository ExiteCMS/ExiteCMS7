...
function parsesmileys($message) {
	...
	$abspath = substr($settings['siteurl'],0,-1) . IMAGES;

	$smiley = array(
		"\:oops\:" => "<img src='".$abspath."smiley/more/redface.gif' alt='smiley' />",
		"\:doubt\:" => "<img src='".$abspath."smiley/more/doubt.gif' alt='smiley' />",
		"\:thumbleft" => "<img src='".$abspath."smiley/more/icon_thumleft.gif' alt='smiley' />",
		"\:thumbright" => "<img src='".$abspath."smiley/more/icon_thumright.gif' alt='smiley' />",
		"\:smt004" => "<img src='".$abspath."smiley/more/004.gif' alt='smiley' />",
		"\:smt005" => "<img src='".$abspath."smiley/more/005.gif' alt='smiley' />",
		"\:smt006" => "<img src='".$abspath."smiley/more/006.gif' alt='smiley' />",
		"\:smt007" => "<img src='".$abspath."smiley/more/007.gif' alt='smiley' />",
		"\:smt008" => "<img src='".$abspath."smiley/more/008.gif' alt='smiley' />",
		"\:smt009" => "<img src='".$abspath."smiley/more/009.gif' alt='smiley' />",
		"\:smt010" => "<img src='".$abspath."smiley/more/010.gif' alt='smiley' />",
		"\:smt011" => "<img src='".$abspath."smiley/more/011.gif' alt='smiley' />",
		"\:smt012" => "<img src='".$abspath."smiley/more/012.gif' alt='smiley' />",
		"\:smt013" => "<img src='".$abspath."smiley/more/013.gif' alt='smiley' />",
		"\:smt014" => "<img src='".$abspath."smiley/more/014.gif' alt='smiley' />",
		"\:smt016" => "<img src='".$abspath."smiley/more/016.gif' alt='smiley' />",
		"\:smt017" => "<img src='".$abspath."smiley/more/017.gif' alt='smiley' />",
		"\:smt018" => "<img src='".$abspath."smiley/more/018.gif' alt='smiley' />",
		"\:smt019" => "<img src='".$abspath."smiley/more/019.gif' alt='smiley' />",
		"\:smt020" => "<img src='".$abspath."smiley/more/020.gif' alt='smiley' />",
		"\:smt021" => "<img src='".$abspath."smiley/more/021.gif' alt='smiley' />",
		"\:smt022" => "<img src='".$abspath."smiley/more/022.gif' alt='smiley' />",
		"\:smt023" => "<img src='".$abspath."smiley/more/023.gif' alt='smiley' />",
		"\:smt024" => "<img src='".$abspath."smiley/more/024.gif' alt='smiley' />",
		"\:smt025" => "<img src='".$abspath."smiley/more/025.gif' alt='smiley' />",
		"\:smt026" => "<img src='".$abspath."smiley/more/026.gif' alt='smiley' />",
		"\:smt027" => "<img src='".$abspath."smiley/more/027.gif' alt='smiley' />",
		"\:smt028" => "<img src='".$abspath."smiley/more/028.gif' alt='smiley' />",
		"\:smt029" => "<img src='".$abspath."smiley/more/029.gif' alt='smiley' />",
		"\:smt030" => "<img src='".$abspath."smiley/more/030.gif' alt='smiley' />",
		"\:smt031" => "<img src='".$abspath."smiley/more/031.gif' alt='smiley' />",
		"\:smt032" => "<img src='".$abspath."smiley/more/032.gif' alt='smiley' />",
		"\:smt033" => "<img src='".$abspath."smiley/more/033.gif' alt='smiley' />",
		"\:smt034" => "<img src='".$abspath."smiley/more/034.gif' alt='smiley' />",
		"\:smt035" => "<img src='".$abspath."smiley/more/035.gif' alt='smiley' />",
		"\:smt036" => "<img src='".$abspath."smiley/more/036.gif' alt='smiley' />",
		"\:smt037" => "<img src='".$abspath."smiley/more/037.gif' alt='smiley' />",
		"\:smt038" => "<img src='".$abspath."smiley/more/038.gif' alt='smiley' />",
		"\:smt039" => "<img src='".$abspath."smiley/more/039.gif' alt='smiley' />",
		"\:smt040" => "<img src='".$abspath."smiley/more/040.gif' alt='smiley' />",
		"\:smt041" => "<img src='".$abspath."smiley/more/041.gif' alt='smiley' />",
		"\:smt042" => "<img src='".$abspath."smiley/more/042.gif' alt='smiley' />",
		"\:smt043" => "<img src='".$abspath."smiley/more/043.gif' alt='smiley' />",
		"\:smt044" => "<img src='".$abspath."smiley/more/044.gif' alt='smiley' />",
		"\:smt045" => "<img src='".$abspath."smiley/more/045.gif' alt='smiley' />",
		"\:smt046" => "<img src='".$abspath."smiley/more/046.gif' alt='smiley' />",
		"\:smt047" => "<img src='".$abspath."smiley/more/047.gif' alt='smiley' />",
		"\:smt048" => "<img src='".$abspath."smiley/more/048.gif' alt='smiley' />",
		"\:smt049" => "<img src='".$abspath."smiley/more/049.gif' alt='smiley' />",
		"\:smt050" => "<img src='".$abspath."smiley/more/050.gif' alt='smiley' />",
		"\:smt051" => "<img src='".$abspath."smiley/more/051.gif' alt='smiley' />",
		"\:smt052" => "<img src='".$abspath."smiley/more/052.gif' alt='smiley' />",
		"\:smt053" => "<img src='".$abspath."smiley/more/053.gif' alt='smiley' />",
		"\:smt054" => "<img src='".$abspath."smiley/more/054.gif' alt='smiley' />",
		"\:smt055" => "<img src='".$abspath."smiley/more/055.gif' alt='smiley' />",
		"\:smt056" => "<img src='".$abspath."smiley/more/056.gif' alt='smiley' />",
		"\:smt057" => "<img src='".$abspath."smiley/more/057.gif' alt='smiley' />",
		"\:smt058" => "<img src='".$abspath."smiley/more/058.gif' alt='smiley' />",
		"\:smt059" => "<img src='".$abspath."smiley/more/059.gif' alt='smiley' />",
		"\:smt060" => "<img src='".$abspath."smiley/more/060.gif' alt='smiley' />",
		"\:smt061" => "<img src='".$abspath."smiley/more/061.gif' alt='smiley' />",
		"\:smt062" => "<img src='".$abspath."smiley/more/062.gif' alt='smiley' />",
		"\:smt063" => "<img src='".$abspath."smiley/more/063.gif' alt='smiley' />",
		"\:smt064" => "<img src='".$abspath."smiley/more/064.gif' alt='smiley' />",
		"\:smt065" => "<img src='".$abspath."smiley/more/065.gif' alt='smiley' />",
		"\:smt066" => "<img src='".$abspath."smiley/more/066.gif' alt='smiley' />",
		"\:smt067" => "<img src='".$abspath."smiley/more/067.gif' alt='smiley' />",
		"\:smt068" => "<img src='".$abspath."smiley/more/068.gif' alt='smiley' />",
		"\:smt069" => "<img src='".$abspath."smiley/more/069.gif' alt='smiley' />",
		"\:smt070" => "<img src='".$abspath."smiley/more/070.gif' alt='smiley' />",
		"\:smt073" => "<img src='".$abspath."smiley/more/073.gif' alt='smiley' />",
		"\:smt074" => "<img src='".$abspath."smiley/more/074.gif' alt='smiley' />",
		"\:smt075" => "<img src='".$abspath."smiley/more/075.gif' alt='smiley' />",
		"\:smt076" => "<img src='".$abspath."smiley/more/076.gif' alt='smiley' />",
		"\:smt077" => "<img src='".$abspath."smiley/more/077.gif' alt='smiley' />",
		"\:smt078" => "<img src='".$abspath."smiley/more/078.gif' alt='smiley' />",
		"\:smt079" => "<img src='".$abspath."smiley/more/079.gif' alt='smiley' />",
		"\:smt080" => "<img src='".$abspath."smiley/more/080.gif' alt='smiley' />",
		"\:smt081" => "<img src='".$abspath."smiley/more/081.gif' alt='smiley' />",
		"\:smt082" => "<img src='".$abspath."smiley/more/082.gif' alt='smiley' />",
		"\:smt083" => "<img src='".$abspath."smiley/more/083.gif' alt='smiley' />",
		"\:smt084" => "<img src='".$abspath."smiley/more/084.gif' alt='smiley' />",
		"\:smt085" => "<img src='".$abspath."smiley/more/085.gif' alt='smiley' />",
		"\:smt086" => "<img src='".$abspath."smiley/more/086.gif' alt='smiley' />",
		"\:smt087" => "<img src='".$abspath."smiley/more/087.gif' alt='smiley' />",
		"\:smt088" => "<img src='".$abspath."smiley/more/088.gif' alt='smiley' />",
		"\:smt089" => "<img src='".$abspath."smiley/more/089.gif' alt='smiley' />",
		"\:smt090" => "<img src='".$abspath."smiley/more/090.gif' alt='smiley' />",
		"\:smt091" => "<img src='".$abspath."smiley/more/091.gif' alt='smiley' />",
		"\:smt092" => "<img src='".$abspath."smiley/more/092.gif' alt='smiley' />",
		"\:smt093" => "<img src='".$abspath."smiley/more/093.gif' alt='smiley' />",
		"\:smt084" => "<img src='".$abspath."smiley/more/094.gif' alt='smiley' />",
		"\:smt095" => "<img src='".$abspath."smiley/more/095.gif' alt='smiley' />",
		"\:smt096" => "<img src='".$abspath."smiley/more/096.gif' alt='smiley' />",
		"\:smt097" => "<img src='".$abspath."smiley/more/097.gif' alt='smiley' />",
		"\:smt098" => "<img src='".$abspath."smiley/more/098.gif' alt='smiley' />",
		"\:smt099" => "<img src='".$abspath."smiley/more/099.gif' alt='smiley' />",
		"\:smt101" => "<img src='".$abspath."smiley/more/101.gif' alt='smiley' />",
		"\:smt103" => "<img src='".$abspath."smiley/more/103.gif' alt='smiley' />",
		"\:smt104" => "<img src='".$abspath."smiley/more/104.gif' alt='smiley' />",
		"\:smt105" => "<img src='".$abspath."smiley/more/105.gif' alt='smiley' />",
		"\:smt106" => "<img src='".$abspath."smiley/more/106.gif' alt='smiley' />",
		"\:smt107" => "<img src='".$abspath."smiley/more/107.gif' alt='smiley' />",
		"\:smt108" => "<img src='".$abspath."smiley/more/108.gif' alt='smiley' />",
		"\:smt109" => "<img src='".$abspath."smiley/more/109.gif' alt='smiley' />",
		"\:smt110" => "<img src='".$abspath."smiley/more/110.gif' alt='smiley' />",
		"\:smt111" => "<img src='".$abspath."smiley/more/111.gif' alt='smiley' />",
		"\:smt112" => "<img src='".$abspath."smiley/more/112.gif' alt='smiley' />",
		"\:smt113" => "<img src='".$abspath."smiley/more/113.gif' alt='smiley' />",
		"\:smt114" => "<img src='".$abspath."smiley/more/114.gif' alt='smiley' />",
		"\:smt115" => "<img src='".$abspath."smiley/more/115.gif' alt='smiley' />",
		"\:smt116" => "<img src='".$abspath."smiley/more/116.gif' alt='smiley' />",
		"\:smt117" => "<img src='".$abspath."smiley/more/117.gif' alt='smiley' />",
		"\:smt118" => "<img src='".$abspath."smiley/more/118.gif' alt='smiley' />",
		"\:smt119" => "<img src='".$abspath."smiley/more/119.gif' alt='smiley' />",
		"\:smt120" => "<img src='".$abspath."smiley/more/120.gif' alt='smiley' />",
		"\:boring" => "<img src='".$abspath."smiley/more/015.gif' alt='smiley' />",
		"\:smt071" => "<img src='".$abspath."smiley/more/071.gif' alt='smiley' />",
		"\:smt102" => "<img src='".$abspath."smiley/more/102.gif' alt='smiley' />",
		"\:smt100" => "<img src='".$abspath."smiley/more/100.gif' alt='smiley' />",
		"\:shock\:" => "<img src='".$abspath."smiley/more/shock.gif' alt='smiley' />",
		"\:lol\:" => "<img src='".$abspath."smiley/more/lol.gif' alt='smiley' />",
		"\:razz\:" => "<img src='".$abspath."smiley/more/razz.gif' alt='smiley' />",
		"\:cry\:" => "<img src='".$abspath."smiley/more/cry.gif' alt='smiley' />",
		"\:evil\:" => "<img src='".$abspath."smiley/more/evil.gif' alt='smiley' />",
		"\:twisted\:" => "<img src='".$abspath."smiley/more/icon_twisted.gif' alt='smiley' />",
		"\:roll\:" => "<img src='".$abspath."smiley/more/rolleyes.gif' alt='smiley' />",
		"\:wink\:" => "<img src='".$abspath."smiley/more/wink.gif' alt='smiley' />",
		"\:idea\:" => "<img src='".$abspath."smiley/more/idea.gif' alt='smiley' />",
		"\:arrow\:" => "<img src='".$abspath."smiley/more/arrow.gif' alt='smiley' />",
		"\:mrgreen\:" => "<img src='".$abspath."smiley/more/icon_mrgreen.gif' alt='smiley' />",
		"\:badgrin\:" => "<img src='".$abspath."smiley/more/badgrin.gif' alt='smiley' />",
		"\;\)" => "<img src='".$abspath."smiley/wink.gif' alt='smiley' />",
		"\:\(" => "<img src='".$abspath."smiley/sad.gif' alt='smiley' />",
		"\:\|" => "<img src='".$abspath."smiley/frown.gif' alt='smiley' />",
		"\:o" => "<img src='".$abspath."smiley/shock.gif' alt='smiley' />",
		"\:p" => "<img src='".$abspath."smiley/pfft.gif' alt='smiley' />",
		"b\)" => "<img src='".$abspath."smiley/cool.gif' alt='smiley' />",
		"\:d" => "<img src='".$abspath."smiley/grin.gif' alt='smiley' />",
		"\:@" => "<img src='".$abspath."smiley/angry.gif' alt='smiley' />",
		"=D&gt;" => "<img src='".$abspath."smiley/more/eusa_clap.gif' alt='smiley' />",
		"\\\:D/" => "<img src='".$abspath."smiley/more/eusa_dance.gif' alt='smiley' />",
		"\:D" => "<img src='".$abspath."smiley/more/biggrin.gif' alt='smiley' />",
		"\:\-D" => "<img src='".$abspath."smiley/more/003.gif' alt='smiley' />",
		"\:\-\)" => "<img src='".$abspath."smiley/more/001.gif' alt='smiley' />",
		"\:\(" => "<img src='".$abspath."smiley/more/sad.gif' alt='smiley' />",
		"\:o" => "<img src='".$abspath."smiley/more/surprised.gif' alt='smiley' />",
		"8\)" => "<img src='".$abspath."smiley/more/cool.gif' alt='smiley' />",
		"\:x" => "<img src='".$abspath."smiley/more/mad.gif' alt='smiley' />",
		"\:\-x" => "<img src='".$abspath."smiley/more/icon_mad.gif' alt='smiley' />",
		"\:P" => "<img src='".$abspath."smiley/more/icon_razz.gif' alt='smiley' />",
		"\;\-\)" => "<img src='".$abspath."smiley/more/002.gif' alt='smiley' />",
		"\:\!\:" => "<img src='".$abspath."smiley/more/exclaim.gif' alt='smiley' />",
		"\:\?\:" => "<img src='".$abspath."smiley/more/question.gif' alt='smiley' />",
		"\:\?" => "<img src='".$abspath."smiley/more/confused.gif' alt='smiley' />",
		"\:\|" => "<img src='".$abspath."smiley/more/neutral.gif' alt='smiley' />",
		"\#\-o" => "<img src='".$abspath."smiley/more/eusa_doh.gif' alt='smiley' />",
		"\=P\~" => "<img src='".$abspath."smiley/more/eusa_drool.gif' alt='smiley' />",
		"\:\^o" => "<img src='".$abspath."smiley/more/eusa_liar.gif' alt='smiley' />",
		"\[\-X" => "<img src='".$abspath."smiley/more/eusa_naughty.gif' alt='smiley' />",
		"\[\-o\<\;" => "<img src='".$abspath."smiley/more/eusa_pray.gif' alt='smiley' />",
		"8\-\[" => "<img src='".$abspath."smiley/more/eusa_shifty.gif' alt='smiley' />",
		"\[\-\(" => "<img src='".$abspath."smiley/more/eusa_snooty.gif' alt='smiley' />",
		"\:\-k" => "<img src='".$abspath."smiley/more/eusa_think.gif' alt='smiley' />",
		"\]\(\*\,\)" => "<img src='".$abspath."smiley/more/eusa_wall.gif' alt='smiley' />",
		"\:\-\"" => "<img src='".$abspath."smiley/more/eusa_whistle.gif' alt='smiley' />",
		"O\:\)" => "<img src='".$abspath."smiley/more/eusa_angel.gif' alt='smiley' />",
		"\=\;" => "<img src='".$abspath."smiley/more/eusa_hand.gif' alt='smiley' />",
		"\:\-\&" => "<img src='".$abspath."smiley/more/eusa_sick.gif' alt='smiley' />",
		"\:\-\(\{\|\=" => "<img src='".$abspath."smiley/more/eusa_boohoo.gif' alt='smiley' />",
		"\:\-\$" => "<img src='".$abspath."smiley/more/eusa_shhh.gif' alt='smiley' />",
		"\:\-s" => "<img src='".$abspath."smiley/more/eusa_eh.gif' alt='smiley' />",
		"\:\-\#" => "<img src='".$abspath."smiley/more/eusa_silenced.gif' alt='smiley' />",
		"\:\)" => "<img src='".$abspath."smiley/smile.gif' alt='smiley' />"
	);
		...
		switch ($exclblock[2]) {
			...
			case "img":
				if ((isURL($exclblock[0]) && verify_image($exclblock[0])) || file_exists(PATH_ROOT.$exclblock[0])) {
					// convert relative to absolute URL's if needed
					if (substr($exclblock[0],0,1) == "/") {
						$exclblock[0] = substr($settings['siteurl'],0,-1) . $exclblock[0];
					}
