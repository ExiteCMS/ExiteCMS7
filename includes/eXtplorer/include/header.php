...
function show_header($dirlinks='') {
	...
	//echo "</div>";
	echo "<td style=\"padding-left: 15px; color:black;\" id=\"bookmark_container\"></td>\n";
	echo "<td width=\"25%\" style=\"padding-left: 15px; color:black; text-align:right;\">".sprintf( $GLOBALS['messages']['switch_file_mode'], $mode . $logoutlink, "<a id=\"switch_file_mode\" href=\"$url".$url_appendix."file_mode=$alternate_mode\">$alternate_mode</a>" ). "
	</td>\n";
	echo "</tr>\n";
