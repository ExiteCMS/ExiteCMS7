{***************************************************************************}
{*                                                                         *}
{* ExiteCMS template: _load_hoteditor.tpl                                  *}
{*                                                                         *}
{***************************************************************************}
{*                                                                         *}
...
<script language="javascript" type="text/javascript" src="{$smarty.const.INCLUDES}jscripts/hoteditor-4.2/editor__0003.js?version=4.2"></script>
{***************************************************************************}
{* End of template                                                         *}
{***************************************************************************}
